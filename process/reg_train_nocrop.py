...
def metadata():
    info = {
    "src_dir" : "/media/NAS/nas_187/soopil/data/MICCAI2015challenge/Abdomen/RawData/Training_2d_nocrop",
    # "src_dir" : "/user/home2/soopil/Datasets/MICCAI2015challenge/Abdomen/RawData/Training_denoise",
    "trg_dir" : "/media/NAS/nas_187/soopil/data/MICCAI2015challenge/Abdomen/RawData/Training_2d_nocrop_reg",
    }
    return info
...
def meta_data():
    ...
    for organ in organs:
        for idx in range(n_sample_per_organ):
            ...
            mov_split[-6] = "Training_2d_nocrop_reg"
