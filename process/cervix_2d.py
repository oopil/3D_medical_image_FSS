...
def metadata():
    ...
    "trg_dir" : "/user/home2/soopil/Datasets/MICCAI2015challenge/Cervix/RawData/Training_2d",
...
def meta_data():
    ...
    with open("cervix_subj_split.json", "w") as json_file:
        ...
        for i, subj_fname in enumerate(subjs):
            ...
            for label in labels_unique:
                ...
                for pos in nonzero_pos:
                    ...
                    try_mkdirs(f"{meta['trg_dir4']}/{label+13}/{option}/img/{subj}")
                    try_mkdirs(f"{meta['trg_dir4']}/{label+13}/{option}/label/{subj}")
                    opath = f"{meta['trg_dir4']}/{label+13}/{option}/img/{subj}/{pos}.npy"
                    np.save(opath, img_slice)
                    opath = f"{meta['trg_dir4']}/{label+13}/{option}/label/{subj}/{pos}.npy"
