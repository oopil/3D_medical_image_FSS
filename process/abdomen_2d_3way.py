...
def metadata():
    info = {
    "src_dir" : "/home/soopil/Datasets/MICCAI2015challenge/Abdomen/RawData/Training",
    # "src_dir" : "/home/soopil/Datasets/MICCAI2015challenge/Abdomen/RawData/Training_denoise",
    # "trg_dir" : "/home/soopil/Datasets/MICCAI2015challenge/Abdomen/RawData/Training_2d_3way",
    "trg_dir" : "/home/soopil/Datasets/MICCAI2015challenge/Abdomen/RawData/Training_2d_3way_re",
    }
    return info
...
def save(dir_path, img_slice, label_slice, label, option, subj, pos, input_size):
    try_mkdirs(f"{dir_path}/{label}/{option}/img_orig/{subj}")
    try_mkdirs(f"{dir_path}/{label}/{option}/label_orig/{subj}")
    opath = f"{dir_path}/{label}/{option}/img_orig/{subj}/{pos}.npy"
    np.save(opath, img_slice)
    opath = f"{dir_path}/{label}/{option}/label_orig/{subj}/{pos}.npy"
    ...
    try_mkdirs(f"{dir_path}/{label}/{option}/img/{subj}")
    try_mkdirs(f"{dir_path}/{label}/{option}/label/{subj}")
    opath = f"{dir_path}/{label}/{option}/img/{subj}/{pos}.npy"
    np.save(opath, img_slice)
    opath = f"{dir_path}/{label}/{option}/label/{subj}/{pos}.npy"
    np.save(opath, label_slice)
...
def meta_data():
    ...
    with open("MICCAI2015_subj_split.json", "r") as json_file:
