...
def metadata():
    info = {
    "src_dir" : "/media/NAS/nas_187/soopil/data/MICCAI2015challenge/Abdomen/RawData/Training_2d_2",
    # "src_dir" : "/user/home2/soopil/Datasets/MICCAI2015challenge/Abdomen/RawData/Training_denoise",
    "trg_dir" : "/media/NAS/nas_187/soopil/data/MICCAI2015challenge/Abdomen/RawData/Training_2d_2_reg_train_v2",
    }
    return info
...
def meta_data():
    ...
    trg_dir_name="Training_2d_2_reg_train_v2"
    print("target directory : ",trg_dir_name)

    ## preprocess
    n_sample_per_organ = 2
    ...
    for organ in organs:
        ...
        for idx in range(n_sample_per_organ):
            ...
            for mov_file in mov_files:
                ...
                cnt += 1
                print(f"organ : {organ},  {idx}/{n_sample_per_organ}", end='\n')
